...
class SendMultiFCMNotification implements ShouldQueue
{
     ...
     */
    public function __construct($firebaseTokens, $data = [])
    {
    ...
    public function handle() : void
    {
        ...
        $report = $messaging->sendMulticast($message, $this->firebaseTokens);
