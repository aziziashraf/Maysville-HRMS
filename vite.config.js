    ...
    plugins: [
        laravel({
            input: [
                ...
                'resources/assets/js/apps/rich-text-handbook.js',
                ...
                'resources/assets/js/users/profile.js',
                ...
                'resources/assets/js/widgets/attendanceStatistics.js',
                'resources/assets/js/widgets/monthlyAttendance.js',
                'resources/assets/js/widgets/leaveTypeDistribution.js',
                'resources/assets/js/widgets/claimTypeDistribution.js',
