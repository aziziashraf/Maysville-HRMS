<x-base-layout :scrollspy="false">
    ...
    <div class="row layout-top-spacing">
        <div class="col-xl-12 col-lg-12 col-sm-12 mx-auto layout-spacing">
            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Claim Approval</h5>
                    <form method="GET" class="row mb-3">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select id="claim_type_id" name="claim_type_id" class="form-select" aria-label="Default select example">
                                <option value=''>--All Claim Types--</option>
                                @foreach($claim_types as $ct)
                                <option value='{{$ct->id}}' <?php echo $filter['claim_type_id']==$ct->id?'selected':''?> >{{$ct->name}}</option>
                                @endforeach
                            </select>
                        </div>
								...
								<tr>
									...
									<td class="text-center">
                                        <div class="action-btns">
                                            <a href="{{ route('claim.requestEdit',$row) }}" class="action-btn btn-edit bs-tooltip me-2" data-toggle="tooltip" data-placement="top" title="Edit">
