        ...
        <div class="col-xl-12 col-lg-12 col-sm-12 mx-auto layout-spacing">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    @can('leave-requestCreate')
                    <div>
	                    <a href="{{ route('leave.requestCreate') }}" class="btn btn-primary mb-2 me-4">Manual Entry</a>
                    </div>
                    @endcan
                    <form method="GET" class="row mb-3">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select id="leave_type_id" name="leave_type_id" class="form-select" aria-label="Default select example">
                                <option value=''>--All Leave Types--</option>
                                @foreach($leave_types as $lt)
                                <option value='{{$lt->id}}' <?php echo $filter['leave_type_id']==$lt->id?'selected':''?> >{{$lt->name}}</option>
                                @endforeach
                            </select>
                        </div>
								...
								<tr>
									...
									<td class="text-center">
                                        <div class="action-btns">
                                            <a href="{{ route('leave.requestEdit',$row) }}" class="action-btn btn-edit bs-tooltip me-2" data-toggle="tooltip" data-placement="top" title="Edit">
