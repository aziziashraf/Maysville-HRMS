<x-base-layout :scrollspy="false">
    ...
    <x-slot:pageTitle>
        Overtime Application | {{ env('APP_NAME') }}
    </x-slot>
    ...
    <div class="row layout-top-spacing">
        <div class="col-xl-12 col-lg-12 col-sm-12 mx-auto layout-spacing">
            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Overtime Application</h5>
                    <div>
	                    <a href="{{ route('overtime.create') }}" class="btn btn-primary mb-2 me-4">Apply Overtime</a>
                    </div>
								...
								<tr>
									...
									<td class="text-center">
                                        <div class="action-btns">
                                            <a href="{{ route('overtime.edit',$row) }}" class="action-btn btn-edit bs-tooltip me-2" data-toggle="tooltip" data-placement="top" title="Edit">
