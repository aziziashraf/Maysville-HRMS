<x-base-layout :scrollspy="false">
    ...
    <x-slot:pageTitle>
        Purchase Requisition | {{ env('APP_NAME') }}
    </x-slot>
    ...
    <div class="row layout-top-spacing">
        <div class="col-xl-12 col-lg-12 col-sm-12 mx-auto layout-spacing">
            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Purchase Requisition</h5>
                    <div>
	                    <a href="{{ route('purchase_requisition.create') }}" class="btn btn-primary mb-2 me-4">New Purchase Requisition</a>
                    </div>
								...
								<tr>
									...
									<td class="text-center">
                                        <div class="action-btns">
                                            <a href="{{ route('purchase_requisition.edit',$row) }}" class="action-btn btn-edit bs-tooltip me-2" data-toggle="tooltip" data-placement="top" title="Edit">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-2"><path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"></path></svg>
                                            </a>
                                            @if($row->source_of_fund == 'personal' && $row->status == 'approved')
                                            @if($row->activeClaims->isNotEmpty())
                                            <a href="{{ route('claim.edit',$row->activeClaims->first()) }}"  class="action-btn btn-create bs-tooltip me-2" data-toggle="tooltip" data-placement="top" title="View Claim">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-dollar-sign"><line x1="12" y1="1" x2="12" y2="23"></line><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"></path></svg>
                                            </a>
                                            @else
                                            <a href="{{ route('purchase_requisition.createClaim',$row) }}"  class="action-btn btn-create bs-tooltip me-2" data-toggle="tooltip" data-placement="top" title="Create Claim">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-dollar-sign"><line x1="12" y1="1" x2="12" y2="23"></line><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"></path></svg>
                                            </a>
                                            @endif
                                            @endif
